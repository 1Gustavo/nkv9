...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:NUKE MODS\n'
            + 'ORG:Owner NUKE MODS;\n'
            + 'TEL;type=CELL;type=VOICE;waid=5519991718371:+55 19 99171 8371\n'
            + 'END:VCARD'

prefix = "!"
name = "NUKE 𝙱𝙾𝚃"
rdaftar = "|𝙊𝙗𝙧𝙞𝙜𝙖𝙙𝙤  𝙥𝙤𝙧 𝙨𝙚 𝙧𝙚𝙜𝙞𝙨𝙩𝙧𝙖𝙧|✅   𝘿𝙞𝙜𝙞𝙩𝙚  !𝙝𝙚𝙡𝙥 𝙤𝙪 !𝙢𝙚𝙣𝙪 𝙥𝙖𝙧𝙖  𝙖𝙘𝙚𝙨𝙨𝙖𝙧  𝙢𝙚𝙪𝙨 𝙘𝙤𝙢𝙖𝙣𝙙𝙤𝙨.."
rmenu = "📢|𝙊𝙞 𝙖𝙢𝙞𝙜𝙤(𝙖) 𝙣𝙖𝙤 𝙨𝙚 𝙚𝙨𝙦𝙪𝙚𝙘𝙖  𝙙𝙚 𝙗𝙚𝙗𝙚𝙧 𝙨𝙪𝙖 𝙖𝙜𝙪𝙖|"
botinfo = "❕𝙄𝙣𝙛𝙤 𝘽𝙤𝙩  ➡️ |𝙀𝙨𝙨𝙚 𝘽𝙊𝙏 𝙛𝙤𝙞 𝙘𝙧𝙞𝙖𝙙𝙤 𝙥𝙖𝙧𝙖 𝙨𝙚𝙧  𝙪𝙨𝙖𝙙𝙤 𝙚𝙢 𝙜𝙧𝙪𝙥𝙤𝙨  𝙘𝙤𝙢 𝙘𝙤𝙢𝙖𝙣𝙙𝙤𝙨 𝙙𝙞𝙫𝙚𝙧𝙩𝙞𝙙𝙤𝙨 𝙚 𝙙𝙞𝙫𝙚𝙧𝙨𝙞𝙛𝙞𝙘𝙖𝙙𝙤𝙨 𝙨𝙚𝙜𝙪𝙞𝙣𝙙𝙤 𝙖𝙨  𝙧𝙚𝙜𝙧𝙖𝙨 𝙙𝙚 𝙘𝙖𝙙𝙖 𝙜𝙧𝙪𝙥𝙤  𝙦𝙪𝙚 𝙥𝙖𝙧𝙩𝙞𝙘𝙞𝙥𝙖|▪️▪️▪️▪️▪️▪️▪️▪️▪️
limitt = 999999999
memberLimit = 2
ban = []
premium = ["5519991718371@s.whatsapp.net","553194639808@s.whatsapp.net","559884368377@s.whatsapp.net"]
...
async function starts() {
	...
	denz.on('connecting', () => {
		start('2', 'NUKE BOT V9 CONECTANDO ...')
	})
	denz.on('open', () => {
		success('2', 'Conectado by Nuke Mods✔')
	})
	...
	denz.on('group-participants-update', async (anu) => {
		...
		if(antifake.includes(anu.jid)) {
			if (anu.action == 'add'){
				...
				if(!num.split('@')[0].startsWith(55)) {
					denz.sendMessage(mdata.id, '𝙲𝚘𝚛𝚛𝚊 𝚜𝚎𝚞 𝚏𝚊𝚔𝚎 𝚜𝚊𝚏𝚊𝚍𝚒𝚗𝚑𝚘(𝚊) 𝚜𝚎𝚞 𝙱𝙰𝙼 𝚎𝚜𝚝𝚊 𝚙𝚛𝚘𝚡𝚒𝚖𝚘', MessageType.text)
		...
		try {
			...
			if (anu.action == 'add') {
				...
				teks = `ᴏʟᴀ @${num.split('@')[0]}👋\nsᴇᴊᴀ ʙᴇᴍ ᴠɪɴᴅᴏ, ᴄᴏɴsᴜʟᴛᴇ  ᴀs ʀᴇɢʀᴀs 😉⏳ *${mdata.subject}*\n\n ────────────────
┏━━━━━━━━━━━━━━━
┃────「 *_ᴀᴘʀᴇsᴇɴᴛᴀᴄᴀᴏ  _* 」─────
┃━━━━━━━━━━━━━━━
┠⊷️ *ɴᴏᴍᴇ* :
...
❕ᴅɪɢɪᴛᴇ ${prefix}daftar 𝚙𝚊𝚛𝚊 𝚌𝚘𝚖𝚎𝚌𝚊𝚛  𝚞𝚜𝚊𝚛 𝚘𝚜 𝚌𝚘𝚖𝚊𝚗𝚍𝚘𝚜  𝚍𝚘 𝚋𝚘𝚝✔`
				...
				teks = `*_「 𝙰𝚍𝚒𝚌𝚒𝚘𝚗𝚊𝚗𝚍𝚘 𝚊𝚍𝚖 」_*\n@${num.split('@')[0]} , ʟɪᴄᴇɴᴄɪᴀᴅᴏ ᴘᴇʟᴏ ᴅᴏɴᴏ ᴅᴏ ɢʀᴜᴘᴏ!`
				let buff = await getBuffer(ppimg)
				denz.sendMessage(mdata.id, buff, MessageType.image, {caption: teks, contextInfo: {"mentionedJid": [num]}})
				...
				teks = `ᴀᴅᴇᴜs @${num.split('@')[0]}👋\nsᴇ ᴠᴏᴄᴇ sᴀɪᴜ ᴘᴏʀ ᴀʟɢᴜᴍ ɪɴᴄᴏᴠᴇɴɪᴇɴᴛᴇ ᴅᴇsᴄᴜʟᴘᴇ, ᴍᴀs sᴇ ᴄᴀᴜsᴏᴜ ᴀʟɢᴜᴍ ᴘʀᴏʙʟᴇᴍᴀ ᴏᴜ ғᴏʀ ɴᴏᴛᴀs ғᴀᴋᴇs ɴᴀᴏ ᴘʀᴇᴄɪsᴀ ᴠᴏʟᴛᴀʀ  𝙽𝚄𝙽𝙲𝙰 𝙼𝙰𝙸𝚂 😉🚫`
				let buff = await getBuffer(ppimg)
				denz.sendMessage(mdata.id, buff, MessageType.image, {caption: teks, contextInfo: {"mentionedJid": [num]}})
			}
		} catch (e) {
		...
		try {
			...
			mess = {
				...
				only: {
					...
					benned: '*❗𝙳𝚎𝚜𝚌𝚞𝚕𝚙𝚊 𝚖𝚊𝚒𝚜  𝚎𝚜𝚜𝚎 𝚌𝚘𝚖𝚊𝚗𝚍𝚘 𝚜𝚘 𝚙𝚘𝚍𝚎 𝚜𝚎𝚛 𝚞𝚜𝚊𝚍𝚘 𝚙𝚎𝚕𝚘 𝚍𝚘𝚗𝚘 *',
					ownerG: '*❗𝙳𝙴𝚂𝙲𝚄𝙻𝙿𝙰 𝙲𝙾𝙼𝙰𝙽𝙳𝙾 𝚂𝙾 𝙿𝙾𝙳𝙴 𝚂𝙴𝚁 𝚄𝚂𝙰𝙳𝙾 𝙿𝙴𝙻𝙾𝚂 𝙰𝙳𝙼 𝙴𝙼 𝙶𝚁𝚄𝙿𝙾𝚂 !*',
					ownerB: '*❗𝙳𝙴𝚂𝙲𝚄𝙻𝙿𝙰 𝙲𝙾𝙼𝙰𝙽𝙳𝙾 𝚂𝙾 𝙿𝙾𝙳𝙴 𝚂𝙴𝚁 𝚄𝚂𝙰𝙳𝙾 𝙿𝙴𝙻𝙾 𝙳𝙾𝙽𝙾 𝙳𝙾 𝙱𝙾𝚃!* ',
					premium: '*❗𝙳𝙴𝚂𝙲𝚄𝙻𝙿𝙰 𝚁𝙴𝙲𝚄𝚁𝚂𝙾 𝚂𝙾 𝙿𝚁𝙰 𝚄𝚂𝚄𝙰𝚁𝙸𝙾 𝙿𝚁𝙴𝙼𝙸𝚄𝙼!*',
					userB: `▪️𝙾𝙻𝙰 𝙹𝙾𝚅𝙴𝙼 *${pushname2}*, 𝚅𝙾𝙲𝙴 𝙽𝙰𝙾 𝙴𝚂𝚃𝙰 𝚁𝙴𝙶𝙸𝚂𝚃𝚁𝙰𝙳𝙾 𝙽𝙾 𝙱𝙰𝙽𝙲𝙾 𝙳𝙴 𝙳𝙰𝙳𝙾𝚂, 𝙳𝙸𝙶𝙸𝚃𝙴 \n*${prefix}daftar*`,
			...
			const ownerNumber = ["5519991718371@s.whatsapp.net"] // owner number ubah aja
...
denz.sendMessage(from, hasil, text, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "ketik #menu kak", 'jpegThumbnail': fs.readFileSync('./sticker/dnsnew.webp')}}}})
		...
		setTimeout( () => {
		reply(`*_「 𝑃𝑎𝑙𝑎𝑣𝑟𝑎 𝑜𝑓𝑒𝑛𝑠𝑖𝑣𝑎 𝐷𝑒𝑡𝑒𝑐𝑡𝑎𝑑𝑎」_*\n𝐷𝑒𝑠𝑐𝑢𝑙𝑝𝑒 *${pushname2}* 𝚟𝚘𝚌𝚎 𝚏𝚊𝚕𝚊 𝚜𝚞𝚓𝚘!  𝚟𝚘𝚌𝚎 𝚜𝚎𝚛𝚊  𝚎𝚡𝚙𝚞𝚕𝚜𝚘 𝚍𝚘 𝚐𝚛𝚞𝚙𝚘 𝚒𝚖𝚎𝚍𝚒𝚊𝚝𝚊𝚖𝚎𝚗𝚝𝚎 *${groupMetadata.subject}*`)
		}, 0)
		}
